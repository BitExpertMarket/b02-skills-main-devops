...
# ☁️ Workflow: Infra Sprint

> IaC TDD sprint: design → PRD → vertical-slice implementation → review → apply
...
```bash
/workflows:infra-sprint [target] [--scope full|quick] [--output md|json|html]
```
